...
Splice donor & GC 0.6560; k-mer 0.8185; seq-head/readout 0.8954 AUROC & Decodable beyond GC and k-mer & Not target-aligned in current artifact & Not target-aligned & Best $\mathrm{PM}=0.5485$; partial & Not audited & Not splice-specific & Auxiliary causal evidence \\
\bottomrule
\end{tabular}
}
\end{table}
